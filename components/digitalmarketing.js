                    ...
                    <div className="container px-5 py-24 mx-auto flex flex-wrap">
                        <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
                            ...
                            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
                                <motion.div whileInView={{ scale: 0.7 }} transition={{ duration: .7 }} className="flex-shrink-0 w-24 h-24 bg-gray-800 text-purple-400 rounded-full inline-flex items-center justify-center">
							...
							L7.741,16.738C7.596,16.882,7.401,16.963,7.197,16.963z"></path>
                                ...
                                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                    <h2 className="font-medium title-font text-purple-500 mb-1 text-xl">Branding: Be Everywhere</h2>
                                    <p className="leading-relaxed text-white opacity-80">Branding, the best way to make your brand stand out of the crowd, and make it look more professional, and give a step ahead your comptition !</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
							...
							L7.741,16.738C7.596,16.882,7.401,16.963,7.197,16.963z"></path>
                                ...
                                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                    <h2 className="font-medium title-font text-purple-500 mb-1 text-xl">Social Media Management: Be In The Top</h2>
                                    <p className="leading-relaxed text-white opacity-80">Your social media profiles help your brand to grow fast and efficient in the digital community !</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex relative pt-10 pb-20 sm:items-center md:w-2/3 mx-auto">
							...
							L7.741,16.738C7.596,16.882,7.401,16.963,7.197,16.963z"></path>
                                ...
                                <div className="flex-grow sm:pl-6 mt-6 sm:mt-0">
                                    <h2 className="font-medium title-font text-purple-500 mb-1 text-xl">Digital Marketing: Reach More</h2>
                                    <p className="leading-relaxed text-white opacity-80">During this Covid-19 situation, the best way to bring traffic and drive more customers to your business is digital marketing, and by using all the available to tools, we will give your brand more exposure and reach more clients for you !</p>
                                </div>
                            </div>
                        </div>
