        ...
        <section id="webdesign" className="py-20 pt-20 px-10 lg:mt-16">
            <div className="relative mt-2 lg:mt-6">
                ...
                <div className="container flex flex-col  gap-x-24">
                    ...
                    <p className="mt-8 flex text-lg text-left text-white text-opacity-75  ">
                    ...
                    <div className=" mt-12 mb-3">
                        <h1 className="text-xl text-left text-purple-500">Great UI/UX Increased Customer Satisfaction:</h1>
                    ...
                    <div className="  mt-12 mb-3">
                        <h1 className="text-xl text-left text-purple-500">Users Stay Hooked on an Interactive UI/UX:
                        </h1>
                    ...
                    <div className=" mt-12 mb-3">
                        <h1 className="text-xl text-left text-purple-500">Good UI/UX Helps To Establish Brand Reputation:</h1>
                    ...
                    <div className="  mt-12 mb-3">
                        <h1 className="text-xl text-left text-purple-500">You Get More Traffic on a Great UI/UX:
                        </h1>
