        ...
        <section id="services" className=" py-20 pt-20 lg:mt-24">
            ...
            <div className="relative mt-20 lg:mt-24 ">
                <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
                    <motion.div whileInView={{ scale: 1.1 }} transition={{ duration: .7 }} className="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
                        <Image className="w-5/6 h-5/6 sm:w-2/4 sm:h-2/4 md:w-full md:h-full  " src={UiandUxIllustration} alt="Godigi ui/ux" width={500} height={500} />
                    </motion.div>
            ...
            <div className="relative mt-20 lg:mt-24">
                <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
                    <motion.div whileInView={{ scale: 1.1 }} transition={{ duration: .7 }} className="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
                        <Image className="w-5/6 h-5/6 sm:w-2/4 sm:h-2/4 md:w-full md:h-full  " src={React} alt="Godigi Web Developemt" width={500} height={500} />
                    </motion.div>
                    <div className="flex flex-1 flex-col items-center lg:items-start">
                        <h1 className="text-3xl  bg-gradient-to-r from-purple-800 to-purple-500 text-transparent bg-clip-text opacity-80">
                            Modern Coding
            ...
            <div className="relative mt-20 lg:mt-24">
                <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
                    <motion.div whileInView={{ scale: 1.1 }} transition={{ duration: .7 }} className="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
                        <Image className="w-5/6 h-5/6 sm:w-2/4 sm:h-2/4 md:w-full md:h-full  " src={Hosting} alt="Godigi Hosting" width={500} height={500} />
                    </motion.div>
                    <div className="flex flex-1 flex-col items-center lg:items-start">
                        <h1 className="text-3xl  bg-gradient-to-r from-purple-800 to-purple-500 text-transparent bg-clip-text opacity-80">
            ...
            <div className="relative mt-20 lg:mt-24">
                <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
                    <motion.div whileInView={{ scale: 1.1 }} transition={{ duration: .7 }} className="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
                        <Image className="w-5/6 h-5/6 sm:w-2/4 sm:h-2/4 md:w-full md:h-full  " src={Digitalmarketing} alt="Godigi Support" width={500} height={500} />
                    </motion.div>
                    <div className="flex flex-1 flex-col items-center lg:items-start">
                        <h1 className="text-3xl  bg-gradient-to-r from-purple-800 to-purple-500 text-transparent bg-clip-text opacity-80">
            ...
            <div className="relative mt-20 lg:mt-24">
                <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
                    <motion.div whileInView={{ scale: 1.1 }} transition={{ duration: .7 }} className="flex flex-1 justify-center z-10 mb-10 lg:mb-0">
                        <Image className="w-5/6 h-5/6 sm:w-2/4 sm:h-2/4 md:w-full md:h-full  " src={Support} alt="Godigi Support" width={500} height={500} />
                    </motion.div>
                    <div className="flex flex-1 flex-col items-center lg:items-start">
                        <h1 className="text-3xl  bg-gradient-to-r from-purple-800 to-purple-500 text-transparent bg-clip-text opacity-80">
