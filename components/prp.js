        ...
        <section id="privacy-policy" className="py-20 pt-20 px-10 lg:mt-16">
            <div className="relative mt-2 lg:mt-6">
                ...
                <div className="container flex flex-col items-center justify-center gap-x-24">
                    ...
                    <h1 className="mt-4 mb-10 flex text-lg text-center text-white opacity-90 ">
                    ...
                    <ul className="list-outside list-disc">
                        ...
                        <li className="mt-4 flex text-lg text-left text-white opacity-90 ">Personal Data: email address, first name, last name, phone number</li>


                        <li className="mt-4 flex text-lg text-left text-purple-900 opacity-90 ">
                            Managing data collection and online surveys:
                        </li>
                        <li className="mt-4 flex text-lg text-left text-white opacity-90 ">Personal Data: email address, first name, last name</li>
                        ...
                        <li className="mt-4 flex text-lg text-left text-white opacity-90 ">Personal Data: Tracker, Usage Data</li>
